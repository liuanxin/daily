...
最后来重点说一下 jdk 7 新增加的 LinkedTransferQueue([[http://www.cs.rochester.edu/u/scott/papers/2009_Scherer_CACM_SSQ.pdf][queue]]).
...
基于上面的w的呼出来了 LinkedTransferQueue, 利用 compareAndSwap 操作, 针对每一个操作进行处理
