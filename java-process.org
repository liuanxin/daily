...
1. 使用 [[https://docs.oracle.com/javase/8/docs/technotes/guides/troubleshoot/tooldescr014.html][jmap]] 命令输出存活对象到文件: ~jmap -dump:live,format=b,file=xxx.hprof $pid~
2. 使用 [[https://docs.oracle.com/javase/8/docs/technotes/guides/troubleshoot/tooldescr006.html][jcmd]] 命令: ~jcmd $pid GC.heap_dump xxx.hprof~
