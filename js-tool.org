...
const formatDate = (date, format) => {
  ...
  return format.trim()
    .replace('yyyy', yyyy).replace('YYYY', yyyy).replace('yy', yy)
    .replace('MM', MM).replace('M', M)
    .replace('dd', dd).replace('DD', dd).replace('d', day)

    .replace('hh', hh).replace('hi', hh).replace('h', h)
    .replace('HH', HH).replace('H', hour)
    .replace('mm', mm).replace('mi', mm).replace('m', minute)
